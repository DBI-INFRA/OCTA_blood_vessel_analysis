...
% ----------------------------------------------------------------------------------
% Description:
%    This function applies the local fuzzy thresholding algorithm for multiregion
%    image segmentation. The algorithm is based on fuzzy c-means clustering and 
%    is designed to segment images with varying intensities & noise by leveraging 
%    local information and fuzzy logic to determine thresholds.
%
% Parameters:
%    - X: The input 2D image to be segmented
%    - nth: The number of thresholds (sets) to be used for segmentation
%    - w: Size of the window for median filtering
%
% Returns:
%    - Y: The segmented binary image 
%
...
% angiography images.
% Source: https://github.com/GUntracht/OCTAVA/blob/main/Scripts/fuzzy_thresholding.m
%
% Reference:
