function [skeletonized_img, binarized_img] = Skeletonization(image, median_filter_size, frangi_opts, ...
    thresholding_method, adaptive_tr_sensitivity, VISUALIZE, save_path)
% ---------------------------------------------------------------------------
% Description:
...
if VISUALIZE
    ...
    save_path2 = strcat(save_path(1:end-4),  "_skeletonized_",thresholding_method, "_", num2str(adaptive_tr_sensitivity), ".png");
