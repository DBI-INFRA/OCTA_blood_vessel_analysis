...
% --------------------------------------------------------------------------------
% Description:
%     This function applies a Frangi filter for vessel enhancement in 2D images.
%     The Frangi filter is a Hessian-based filtering method commonly used in
%     various types of angiography and improves the visibility of blood vessels 
%     by enhancing tubular structures in the image. 
%
% Parameters:
%   - X: The input 2D image
%   - opts: Structure containing the following filter options:
%           - sigmarange & sigmastepsize
%           - correctionconst1 & correctionconst2
%
% Returns:
%    - Y: The filtered image with enhanced vessels
%
% This script was developed by Untracht GR et al. (2021) as part of the 
% OCTAVA toolbox for the analysis of optical coherence tomography
% angiography images.
% Source: https://github.com/GUntracht/OCTAVA/blob/main/Scripts/frangi_2Dfilter.m
%
% Paper Reference:
%    A. F. Frangi, W. J. Niessen, K. L. Vincken, and M. A. Viergever, 
%    "Multiscale Vessel Enhancement Filtering," in Medical Image Computing 
%    and Computer-Assisted Intervention, Lecture Notes in Computer Science, 
%    Wells WM, C. A, and Delp S, Eds. Verlag: Springer, 1998, pp. 130–137.
% --------------------------------------------------------------------------------
