...
- **"SPD_not_found.txt"**: Text file that will log all images where the SPD depth could not be calculated. In these cases, you can manually select the SPD depth by examining the graphs found in "2_CLD_SPD_estimation/" and editing "ImageSummary.csv" as specified above.
